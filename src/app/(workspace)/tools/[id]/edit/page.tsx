...
import { updateToolAction } from "@/server/items/actions";
...
export async function EditToolContent({ id }: { id: string }) {
    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-6 lg:px-8 lg:py-8">
      ...
      <Card className="rounded-3xl border-border/60 shadow-sm overflow-hidden">
        ...
        <CardContent className="px-6 py-8">
          <ItemForm
            type="tool"
            action={updateToolAction.bind(null, item.id)}
            submitLabel="更新 Tool"
