...
- 当前已落地：Next.js 16 App Router、统一工作台壳层、`/login`、工作台登录守卫、Supabase migration、`server/auth`、`server/db`、`lib/schema`
- 当前页面仍以静态样例数据展示为主：真实库体验 CRUD、搜索、复制交互会在 Phase 3 接到页面
