...
- `2026-05-02`：Phase 5 GitHub Skill 导入与 MVP 收口已落地在 `codex/phase-5-github-import`，已通过本地 Supabase + DeepSeek + GitHub 真实浏览器验收
...
- `docs/integration-guide.md`：本地接入、环境变量、Route Handler 用法、Phase 4 冒烟流程
- `PLAN.md`：分阶段实施计划
...
- `src/app/api`：已实现的 Route Handlers，例如智能整理接口
